...
coordinates_array = np.array(all_3D)

# Compute the mean of the 3D coordinates
mean_coordinate = np.mean(coordinates_array, axis=0)

print("Mean 3D Coordinate:", mean_coordinate)
# print(frame)
# plot_rays_from_positions_orientations_quaternions(frame)
# Clean up windows
